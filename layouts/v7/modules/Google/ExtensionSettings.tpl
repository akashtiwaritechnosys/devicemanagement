			...
			<div class="col-sm-12 col-xs-12">
				<table class="listview-table table-bordered" align="center">
					...
					<tbody>
						<tr>
							<td>
								<select name="Contacts[google_group]" class="inputElement select2 row" style="max-width: 310px;">
						...
						<tr>
							<td>
								<select name="Calendar[google_group]" class="inputElement select2 row" style="max-width: 310px;">
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				<div class="vt-default-callout vt-info-callout marginLeft10px"> 
					...
					<br>
					<img src="modules/Google/images/redirect_uri.png" style="width:70%" />
				</div>
			</div>
		</div>
