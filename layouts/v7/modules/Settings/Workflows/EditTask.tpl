                  ...
                  <div class="tabbable">
                     <div class="row form-group">
                        <div class="col-sm-9 col-xs-9">
                            <div class="row">
                                <div class="col-lg-2 col-sm-4"><label>{vtranslate('LBL_TASK_TITLE',$QUALIFIED_MODULE)}</label><span class="redColor">*</span></div>
                                <div class="col-lg-6 col-sm-8"><input name="summary" class="inputElement" data-rule-required="true" type="text" value="{$TASK_MODEL->get('summary')}" /></div>
                            </div>
                        </div>
                     </div>
                     {if $TASK_TYPE_MODEL->get('tasktypename') eq "VTEmailTask" && $TASK_OBJECT->trigger != null}                   
                        ...
                        <div class="row form-group">
                            <div class="col-sm-9 col-xs-9">
                                <div class="row">
                                    <div class="col-lg-2 col-sm-4"> <label>{vtranslate('LBL_DELAY_ACTION', $QUALIFIED_MODULE)}</label> </div>
