			...
			<form class="form-horizontal" id="cronJobSaveAjax" method="post" action="index.php">
				...
				<div class="modal-body">
					<div class="form-group">
						<label class="control-label fieldLabel col-xs-4">{vtranslate('LBL_STATUS',$QUALIFIED_MODULE)}</label>
					...
					<div class="form-group">
						<label class="control-label fieldLabel col-xs-4">{vtranslate('Frequency',$QUALIFIED_MODULE)}</label>
						...
						{/if}
						<div class="controls fieldValue col-xs-3">
						...
						<div class="controls fieldValue col-xs-4" style="padding-left: 0px;">
