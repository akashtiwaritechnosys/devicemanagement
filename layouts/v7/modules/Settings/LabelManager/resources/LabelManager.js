...
$(document).ready(function () {
  ...
  // ------------- sidebar dropdown behavior start---------------
...
//   jQuery(".app-modules-dropdown-container").on("click", function (e) {
//     e.stopPropagation();
//     var dropdownContainer = jQuery(this);
...
//         .removeClass("open")
//         .find(".app-item")
//         .removeClass("active-app-item");
//       dropdownContainer.find(".fa-chevron-right").removeClass("rotate-chevron");
//     } else {
//       // Close others
//       jQuery(".app-modules-dropdown-container")
//         .removeClass("open")
//         .find(".app-item")
//         .removeClass("active-app-item");
//       jQuery(".app-modules-dropdown-container")
//         .find(".fa-chevron-right")
//         .removeClass("rotate-chevron");
...
//       dropdownContainer.find(".fa-chevron-right").addClass("rotate-chevron");
//     }
//   });

  // ------------- sidebar dropdown behavior end---------------
  ...
  jQuery(".nextButton").on("click", function () {
    ...
    var url =
      "index.php?module=LabelManager&parent=Settings&view=LabelManager&mode=languageManage&sourceModule=" +
      sourceModule +
      "&language=" +
      language;
    window.location.href = url;
  ...
  jQuery(".saveButton").on("click", function () {
    ...
    app.request.post({ data: params }).then(function (err, data) {
      ...
      var url =
        "index.php?module=LabelManager&parent=Settings&view=LabelManager&mode=languageSettings";
      window.location.href = url;
    });
  });
});
