                ...
                <form id="pickListDependencyForm" class="form-horizontal" method="POST">
                    ...
                    <div class="editViewBody">
                        <div class="editViewContents editdependency">
                            ...
                            <div class="form-group">
                                <label class="muted control-label col-lg-3 col-md-4 col-sm-4 col-xs-4">{vtranslate('LBL_SOURCE_FIELD', $QUALIFIED_MODULE)}</label>
                                <div class="controls col-lg-5 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <div class="form-group">
                                <label class="muted control-label col-lg-3 col-md-4 col-sm-4 col-xs-4">{vtranslate('LBL_TARGET_FIELD', $QUALIFIED_MODULE)}</label>
                                <div class="controls col-lg-5 col-md-6 col-sm-6 col-xs-6">
