                ...
                <div class="modal-body">
                    ...
                    <div class="quickCreateContent">
                        <table class="massEditTable table no-border">
                            ...
                            <input type="hidden" id="documentFileName" name="documentFileName" value="">
                            <input type="hidden" id="documentFileData" name="documentFileData" value="">
                            <input type="hidden" id="documentFileSize" name="documentFileSize" value="">
                            <input type="hidden" id="documentFileType" name="documentFileType" value="">
                        </table>
                    </div>
                </div>
