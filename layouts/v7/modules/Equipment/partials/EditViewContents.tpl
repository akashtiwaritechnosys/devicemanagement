{strip}
	...
	<div name='editContent' style="padding-top: 30px;">
		...
		{foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name=blockIterator}
			...
			<div class='fieldBlockContainer' {if $BLOCK_LABEL eq 'Contract Details'}id="loki"{/if} data-block="{$BLOCK_LABEL}">
						...
						<tr>
							...
							{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
								...
								{if $FIELD_MODEL->isEditable() eq true}
									...
									{/if}
									<td id="{$FIELD_MODEL->getFieldName()}_Label" class="fieldLabel alignMiddle" data-td="{$FIELD_MODEL->getFieldName()}">
