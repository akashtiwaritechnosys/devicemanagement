    ...
    <div class="modal-dialog modelContainer">
        ...
        <div class="modal-content">
            <form id="AddComment" name="AddComment">
                ...
                <input type="hidden" name="apStatus" value="Approve"/> 
                ...
                <div class="modal-body clearfix">
                    ...
                    <div class="col-lg-6">
                        <textarea type="text" id="approvepart_comment" name="approvepart_comment" data-rule-required="true" class="inputElement"></textarea>
                    </div>
                </div>
