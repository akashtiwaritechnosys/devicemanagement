    ...
    <div class="modal-dialog modelContainer">
        ...
        <div class="modal-content">
            <form id="AddComment" name="AddComment">
                ...
                <input type="hidden" name="apStatus" value="ApproveByHead"/> 
                <input type="hidden" name="record" value="{$RECORD_ID}"/>
                <div class="modal-body clearfix">
                    <div class="col-lg-5">
                        <label class="control-label pull-right marginTop5px">
                            {vtranslate('Comment By Service Head',$MODULE)}&nbsp;<span class="redColor">*</span>
                        </label>
                    </div>
                    <div class="col-lg-6">
                        <textarea type="text" id="approvepart_service" name="approvepart_service" data-rule-required="true" class="inputElement"></textarea>
                    </div>
                </div>
