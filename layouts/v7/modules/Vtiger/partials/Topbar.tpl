					...
					<ul class="nav navbar-nav top-navbar">
						<li>
							<div class="dropdown pull-left">
								...
								<ul class="dropdown-menu dropdown-menu-container" role="menu" aria-labelledby="dropdownMenu1">
													...
													{if $quickCreateModule == '1'}
														{if $count % 3 == 0}
															...
															{if $singularLabel == 'SINGLE_Calendar'}
																...
																<div class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4 col-md-4 col-xs-6{/if}">
															...
															{else if $singularLabel == 'SINGLE_Documents'}
																<div class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4 col-md-4 col-xs-6{/if} dropdown">
							...
							<div>
								<a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button">
									<span class="" aria-hidden="true" title="{$USER_MODEL->get('userlabel')}
										  ({$USER_MODEL->get('user_name')})"><img class="profile-icon" src="layouts/v7/skins//images/profile-icon.png" /></span>
