/*! gridster.js - v0.5.6 - 2014-09-25 - * http://gridster.net/ - Copyright (c) 2014 ducksboard; Licensed MIT */ (function (
  t,
  i
) {
  "function" == typeof define && define.amd
    ? define("gridster-coords", ["jquery"], i)
    : (t.GridsterCoords = i(t.$ || t.jQuery));
})(this, function (t) {
  function i(i) {
    return (
      i[0] && t.isPlainObject(i[0]) ? (this.data = i[0]) : (this.el = i),
      (this.isCoords = !0),
      (this.coords = {}),
      this.init(),
      this
  ...
  return (
    ...
    (e.set = function (t, i) {
      ...
      var r = this.data;
      return (
        r.left === void 0 && (r.left = r.x1),
        r.top === void 0 && (r.top = r.y1),
        (this.coords.x1 = r.left),
        (this.coords.y1 = r.top),
        (this.coords.x2 = r.left + r.width),
        (this.coords.y2 = r.top + r.height),
        (this.coords.cx = r.left + r.width / 2),
        (this.coords.cy = r.top + r.height / 2),
        (this.coords.width = r.width),
        (this.coords.height = r.height),
        (this.coords.el = e || !1),
        this
      );
    }),
  ...
  (function (t, i) {
    "function" == typeof define && define.amd
      ? define("gridster-collision", ["jquery", "gridster-coords"], i)
      : (t.GridsterCollision = i(t.$ || t.jQuery, t.GridsterCoords));
  })(this, function (t) {
    function i(i, s, r) {
    ...
    return (
      ...
      (s.detect_overlapping_region = function (t, i) {
        var e = "",
          s = "";
        return (
          t.y1 > i.cy && t.y1 < i.y2 && (e = "N"),
          t.y2 > i.y1 && t.y2 < i.cy && (e = "S"),
          t.x1 > i.cx && t.x1 < i.x2 && (s = "W"),
          t.x2 > i.x1 && t.x2 < i.cx && (s = "E"),
          e + s || "C"
        );
      }),
      (s.calculate_overlapped_area_coords = function (i, e) {
        ...
        return t({ left: s, top: r, width: o - s, height: a - r })
          .coords()
          .get();
      }),
      ...
      (s.manage_colliders_start_stop = function (i, e, s) {
        for (
          var r = this.last_colliders_coords, o = 0, a = r.length;
          a > o;
          o++
        )
          -1 === t.inArray(r[o], i) && e.call(this, r[o]);
        for (var n = 0, h = i.length; h > n; n++)
          -1 === t.inArray(i[n], r) && s.call(this, i[n]);
      }),
      (s.find_collisions = function (i) {
        for (
          var e = this,
            s = this.options.overlapping_region,
            r = [],
            o = [],
            a = this.colliders || this.$colliders,
            n = a.length,
            h = e.$element
              .coords()
              .update(i || !1)
          ...
          if (c) {
            ...
            if (p === s || "all" === s) {
              ...
              e.options.on_overlap && e.options.on_overlap.call(this, f),
                r.push(d),
                o.push(f);
            }
          }
        ...
        return (
          (e.options.on_overlap_stop || e.options.on_overlap_start) &&
            this.manage_colliders_start_stop(
              r,
              e.options.on_overlap_start,
              e.options.on_overlap_stop
            ),
      ...
      (s.get_closest_colliders = function (t) {
        ...
        return (
          i.sort(function (t, i) {
            return "C" === t.region && "C" === i.region
              ? t.coords.y1 < i.coords.y1 || t.coords.x1 < i.coords.x1
                ? -1
                : 1
              : t.area < i.area
              ? 1
      ...
      (s.set_colliders = function (i) {
        "string" == typeof i || i instanceof t
          ? (this.$colliders = t(i, this.options.colliders_context).not(
              this.$element
            ))
          : (this.colliders = t(i));
      }),
  ...
  (function (t, i) {
    "function" == typeof define && define.amd
      ? define("gridster-draggable", ["jquery"], i)
      : (t.GridsterDraggable = i(t.$ || t.jQuery));
  })(this, function (t) {
    function i(i, s) {
      (this.options = t.extend({}, e, s)),
        (this.$document = t(document)),
        (this.$container = t(i)),
        (this.$dragitems = t(this.options.items, this.$container)),
        (this.is_dragging = !1),
    ...
    return (
      (_.init = function () {
        ...
        this.calculate_dimensions(),
          this.$container.css("position", "static" === i ? "relative" : i),
          (this.disabled = !1),
          this.events(),
          t(window).bind(
            this.nsEvent("resize"),
            throttle(t.proxy(this.calculate_dimensions, this), 200)
          );
      }),
      ...
      (_.events = function () {
        (this.pointer_events = {
          ...
          this.$container.on(
            ...
            t.proxy(this.on_select_start, this)
          ),
          this.$container.on(
            this.pointer_events.start,
            this.options.items,
            t.proxy(this.drag_handler, this)
          ),
          this.$document.on(
            ...
            t.proxy(function (t) {
              (this.is_dragging = !1),
                this.disabled ||
                  ...
                  this.drag_start && this.on_dragstop(t));
            }, this)
          );
      }),
      ...
      (_.get_offset = function (i) {
        ...
        return (
          this.options.limit &&
            (o > this.player_max_left
              ? (o = this.player_max_left)
              : this.player_min_left > o && (o = this.player_min_left)),
          {
            position: { left: o, top: a },
            pointer: {
              left: e.left,
              top: e.top,
      ...
      (_.get_drag_data = function (t) {
        ...
        return (
          ...
          (i.$helper = this.helper ? this.$helper : this.$player),
          i
        );
      }),
      (_.set_limits = function (t) {
        return (
          t || (t = this.$container.width()),
          (this.player_max_left =
            t - this.player_width + -this.options.offset_left),
          (this.options.container_width = t),
          this
        );
      }),
      (_.scroll_in = function (i, e) {
        ...
        return (
          y >= w &&
            ((o = g + _),
            v > o &&
              (s["scroll" + a(n)](o), (this["scroll_offset_" + i] += _))),
          m >= y &&
            ((o = g - _),
            o > 0 &&
              (s["scroll" + a(n)](o), (this["scroll_offset_" + i] -= _))),
      ...
      (_.drag_handler = function (i) {
        if (
          (i.target.nodeName,
          !this.disabled && (1 === i.which || o) && !this.ignore_drag(i))
        ) {
          var e = this,
            s = !0;
          return (
            (this.$player = t(i.currentTarget)),
            (this.el_init_pos = this.get_actual_pos(this.$player)),
            (this.mouse_init_pos = this.get_mouse_pos(i)),
            (this.offsetY = this.mouse_init_pos.top - this.el_init_pos.top),
            this.$document.on(this.pointer_events.move, function (t) {
              var i = e.get_mouse_pos(t),
                r = Math.abs(i.left - e.mouse_init_pos.left),
                o = Math.abs(i.top - e.mouse_init_pos.top);
              return r > e.options.distance || o > e.options.distance
                ? s
                  ? ((s = !1), e.on_dragstart.call(e, t), !1)
      ...
      (_.on_dragstart = function (i) {
        ...
        return (
          (this.baseX = Math.round(e.left)),
          (this.baseY = Math.round(e.top)),
          (this.initial_container_width =
            this.options.container_width || this.$container.width()),
          "clone" === this.options.helper
            ? ((this.$helper = this.$player
              ...
              (this.helper = !0))
            : (this.helper = !1),
          (this.win_offset_y = t(window).scrollTop()),
          (this.win_offset_x = t(window).scrollLeft()),
          ...
          this.options.start &&
            this.options.start.call(this.$player, i, this.get_drag_data(i)),
          !1
        );
      }),
      (_.on_dragmove = function (t) {
        var i = this.get_drag_data(t);
        this.options.autoscroll && this.manage_scroll(i),
          this.options.move_element &&
        ...
        return (
          (i.prev_position = e),
          this.options.drag && this.options.drag.call(this.$player, t, i),
          (this.last_position = i.position),
          !1
        );
      }),
      (_.on_dragstop = function (t) {
        ...
        return (
          (this.drag_start = !1),
          this.options.stop && this.options.stop.call(this.$player, t, i),
      ...
      (_.destroy = function () {
        this.disable(),
          ...
          t.removeData(this.$container, "drag");
      }),
      (_.ignore_drag = function (i) {
        return this.options.handle
          ? !t(i.target).is(this.options.handle)
          : t.isFunction(this.options.ignore_dragging)
          ? this.options.ignore_dragging(i)
          : t(i.target).is(this.options.ignore_dragging.join(", "));
      }),
  ...
  (function (t, i) {
    "function" == typeof define && define.amd
      ? define(["jquery", "gridster-draggable", "gridster-collision"], i)
      : (t.Gridster = i(
          t.$ || t.jQuery,
          t.GridsterDraggable,
          t.GridsterCollision
    ...
    function e(i, e) {
      (this.options = t.extend(!0, {}, s, e)),
        ...
        (this.min_widget_width =
          2 * this.options.widget_margins[0] +
          this.options.widget_base_dimensions[0]),
        (this.min_widget_height =
          2 * this.options.widget_margins[1] +
    ...
    (e.defaults = s),
      (e.generated_stylesheets = []),
      (e.sort_by_row_asc = function (i) {
        return (i = i.sort(function (i, e) {
          return (
            i.row || ((i = t(i).coords().grid), (e = t(e).coords().grid)),
            i.row > e.row ? 1 : -1
          );
        }));
      }),
    ...
    return (
      (r.init = function () {
        this.options.resize.enabled && this.setup_resize(),
          ...
          t(window).bind(
            "resize.gridster",
            throttle(t.proxy(this.recalculate_faux_grid, this), 200)
          );
      }),
      (r.disable = function () {
        return (
      ...
      (r.add_widget = function (i, e, s, r, o, a, n) {
        ...
        e || (e = 1),
          s || (s = 1),
          !r & !o
            ? (h = this.next_position(e, s))
            : ((h = { col: r, row: o, size_x: e, size_y: s }),
        ...
        var _ = t(i)
          ...
          .hide();
        return (
          (this.$widgets = this.$widgets.add(_)),
          this.register_widget(_),
          this.add_faux_rows(h.size_y),
          a && this.set_widget_max_size(_, a),
          n && this.set_widget_min_size(_, n),
          this.set_dom_grid_width(),
          this.set_dom_grid_height(),
      ...
      (r.resize_widget = function (t, i, e, s) {
        ...
        i || (i = r.size_x),
          e || (e = r.size_y),
          1 / 0 !== a && (i = Math.min(i, a - o + 1)),
          e > n && this.add_faux_rows(Math.max(e - n, 0));
        var d = o + i - 1;
        d > this.cols && this.add_faux_cols(d - this.cols);
        var l = { col: _, row: r.row, size_x: i, size_y: e };
        return (
          this.mutate_widget_in_gridmap(t, r, l),
          this.set_dom_grid_height(),
          this.set_dom_grid_width(),
          s && s.call(this, l.size_x, l.size_y),
          t
        );
      }),
      (r.mutate_widget_in_gridmap = function (i, e, s) {
        ...
        if (
          ...
          (e.size_x = s.size_x),
          (e.size_y = s.size_y),
          this.add_to_gridmap(s, i),
          i.removeClass("player-revert"),
          i
            .data("coords")
            .update({
              width:
                s.size_x * this.options.widget_base_dimensions[0] +
                2 * (s.size_x - 1) * this.options.widget_margins[0],
              height:
                s.size_y * this.options.widget_base_dimensions[1] +
                2 * (s.size_y - 1) * this.options.widget_margins[1],
            }),
          i.attr({
            "data-col": s.col,
            "data-row": s.row,
      ...
      (r.remove_widget = function (i, e, s) {
        var r = i instanceof t ? i : t(i),
          o = r.coords().grid;
        t.isFunction(e) && ((s = e), (e = !1)),
          (this.cells_occupied_by_placeholder = {}),
          (this.$widgets = this.$widgets.not(r));
      ...
      (r.register_widget = function (i) {
        ...
        return (
          o &&
            ((s.row = o),
            i.attr("data-row", o),
            this.$el.trigger("gridster:positionchanged", [s]),
            (r = !0)),
          this.options.avoid_overlapped_widgets &&
            !this.can_move_to(
              { size_x: s.size_x, size_y: s.size_y },
              s.col,
              s.row
            ) &&
            (t.extend(s, this.next_position(s.size_x, s.size_y)),
            i.attr({
              "data-col": s.col,
              "data-row": s.row,
              "data-sizex": s.size_x,
            ...
            (r = !0)),
          i.data("coords", i.coords()),
          (i.data("coords").grid = s),
          this.add_to_gridmap(s, i),
          this.options.resize.enabled && this.add_resize_handle(i),
          r
        );
      }),
      (r.update_widget_position = function (t, i) {
        return (
          this.for_each_cell_occupied(t, function (t, e) {
      ...
      (r.draggable = function () {
        var i = this,
          e = t.extend(!0, {}, this.options.draggable, {
            ...
            limit: !0,
            start: function (e, s) {
              i.$widgets.filter(".player-revert").removeClass("player-revert"),
                (i.$player = t(this)),
                (i.$helper = t(s.$helper)),
                (i.helper = !i.$helper.is(i.$player)),
                i.on_start_drag.call(i, e, s),
                i.$el.trigger("gridster:dragstart");
            },
            stop: function (t, e) {
      ...
      (r.setup_resize = function () {
        ...
        var i = this.options.resize.axes,
          e =
            ...
            '-{type}" />';
        return (
          (this.resize_handle_tpl = t
            .map(i, function (t) {
              return e.replace("{type}", t);
            })
            .join("")),
          t.isArray(this.options.draggable.ignore_dragging) &&
      ...
      (r.on_start_drag = function (i, e) {
        this.$helper.add(this.$player).add(this.$wrapper).addClass("dragging"),
          ...
          (this.placeholder_grid_data = t.extend({}, this.player_grid_data)),
          this.set_dom_grid_height(
            this.$el.height() +
        ...
        this.options.autogrow_cols &&
          s >= r &&
          this.add_faux_cols(Math.min(s - r, 1));
        ...
        (this.cells_occupied_by_player = this.get_cells_occupied(
          ...
          (this.$preview_holder = t("<" + this.$player.get(0).tagName + " />", {
          ...
          this.options.draggable.start &&
            this.options.draggable.start.call(this, i, e);
      }),
      (r.on_drag = function (t, i) {
        ...
        if (this.options.autogrow_cols) {
          var s =
            ...
            this.placeholder_grid_data.size_x -
            1;
          s >= this.cols - 1 &&
        ...
        (this.colliders_data = this.collision_api.get_closest_colliders(e)),
          ...
          this.helper &&
            this.$player &&
            this.$player.css({ left: i.position.left, top: i.position.top }),
          this.options.draggable.drag &&
            this.options.draggable.drag.call(this, t, i);
      }),
      (r.on_stop_drag = function (t, i) {
        this.$helper
          ...
          (i.position.left = i.position.left + this.baseX),
          (i.position.top = i.position.top + this.baseY),
          ...
          this.options.draggable.stop &&
            this.options.draggable.stop.call(this, t, i),
      ...
      (r.on_start_resize = function (i, e) {
        (this.$resized_widget = e.$player.closest(".gs-w")),
          ...
          (this.resize_max_size_y =
            this.resize_wgd.max_size_y || this.options.resize.max_size[1]),
          (this.resize_min_size_x =
            this.resize_wgd.min_size_x || this.options.resize.min_size[0] || 1),
          (this.resize_min_size_y =
            this.resize_wgd.min_size_y || this.options.resize.min_size[1] || 1),
        ...
        (this.$resize_preview_holder = t("<" + s + " />", {
          ...
          this.options.resize.start &&
            this.options.resize.start.call(this, i, e, this.$resized_widget),
          ...
          delay(
            t.proxy(function () {
              this.$resize_preview_holder
                ...
                this.options.resize.stop &&
                  this.options.resize.stop.call(
                    this,
                    i,
                    e,
                    this.$resized_widget
      ...
      (r.on_resize = function (t, i) {
        var e,
          ...
          g = 1 / 0,
          u = 1 / 0,
          f = Math.ceil(s / (o + 2 * n) - 0.2),
          w = Math.ceil(r / (a + 2 * h) - 0.2),
          m = Math.max(1, this.resize_initial_sizex + f),
          y = Math.max(1, this.resize_initial_sizey + w),
          v =
            this.container_width / this.min_widget_width -
            this.resize_initial_col +
            1,
          z = v * this.min_widget_width - 2 * n;
        if (
          ((m = Math.max(Math.min(m, _), d)),
          (m = Math.min(v, m)),
          (e = _ * o + 2 * (m - 1) * n),
          (g = Math.min(e, z)),
          (min_width = d * o + 2 * (m - 1) * n),
          (y = Math.max(Math.min(y, l), c)),
          (u = l * a + 2 * (y - 1) * h),
          (min_height = c * a + 2 * (y - 1) * h),
          this.resize_dir.right
            ? (y = this.resize_initial_sizey)
            : this.resize_dir.bottom && (m = this.resize_initial_sizex),
          p)
        ) {
          var x = this.resize_initial_col + m - 1;
          p &&
            x >= this.resize_initial_last_col &&
            (this.set_dom_grid_width(Math.max(x + 1, this.cols)),
            x > this.cols && this.add_faux_cols(x - this.cols));
        }
        var $ = {};
        !this.resize_dir.bottom &&
          ($.width = Math.max(
            Math.min(this.resize_initial_width + s, g),
            min_width
          )),
          !this.resize_dir.right &&
            ($.height = Math.max(
              Math.min(this.resize_initial_height + r, u),
              min_height
            )),
          this.$resized_widget.css($),
          (m !== this.resize_last_sizex || y !== this.resize_last_sizey) &&
            (this.resize_widget(this.$resized_widget, m, y),
            this.set_dom_grid_width(this.cols),
            this.$resize_preview_holder
              .css({ width: "", height: "" })
              .attr({
          ...
          this.options.resize.resize &&
            this.options.resize.resize.call(this, t, i, this.$resized_widget),
          this.$el.trigger("gridster:resize"),
          (this.resize_last_sizex = m),
          (this.resize_last_sizey = y);
      }),
      (r.on_overlapped_column_change = function (i, e) {
        if (!this.colliders_data.length) return this;
        var s,
          r = this.get_targeted_columns(this.colliders_data[0].el.data.col),
          o = this.last_cols.length,
          a = r.length;
        for (s = 0; a > s; s++)
          -1 === t.inArray(r[s], this.last_cols) &&
            (i || t.noop).call(this, r[s]);
        for (s = 0; o > s; s++)
          -1 === t.inArray(this.last_cols[s], r) &&
            (e || t.noop).call(this, this.last_cols[s]);
        return (this.last_cols = r), this;
      }),
      (r.on_overlapped_row_change = function (i, e) {
        if (!this.colliders_data.length) return this;
        var s,
          r = this.get_targeted_rows(this.colliders_data[0].el.data.row),
          o = this.last_rows.length,
          a = r.length;
        for (s = 0; a > s; s++)
          -1 === t.inArray(r[s], this.last_rows) &&
            (i || t.noop).call(this, r[s]);
        for (s = 0; o > s; s++)
          -1 === t.inArray(this.last_rows[s], r) &&
            (e || t.noop).call(this, this.last_rows[s]);
        this.last_rows = r;
      }),
      (r.set_player = function (t, i, e) {
        var s = this;
        e || this.empty_cells_player_occupies();
        var r = e ? { col: t } : s.colliders_data[0].el.data,
          o = r.col,
          a = i || r.row;
        (this.player_grid_data = {
          col: o,
        ...
        if (
          (this.manage_movements(h.can_go_up, o, a),
          this.manage_movements(h.can_not_go_up, o, a),
          !n.length)
        ) {
        ...
        return (
          t.each(
            ...
            t.proxy(function (t, i) {
              ...
              if (a)
                this.move_widget_to(o, a),
                  this.set_placeholder(e, a + r.size_y);
              else {
      ...
      (r.is_empty = function (t, i) {
        return this.gridmap[t] !== void 0
          ? this.gridmap[t][i] !== void 0 && this.gridmap[t][i] === !1
            ? !0
            : !1
          : !0;
      }),
      ...
      (r.set_placeholder = function (i, e) {
        ...
        (this.placeholder_grid_data.col = i),
          (this.placeholder_grid_data.row = e),
          (this.cells_occupied_by_placeholder = this.get_cells_occupied(
            this.placeholder_grid_data
          )),
          this.$preview_holder.attr({ "data-row": e, "data-col": i }),
          (a || n) &&
            r.each(
              t.proxy(function (e, r) {
                this.move_widget_up(
                  t(r),
                  this.placeholder_grid_data.col - i + s.size_y
                );
              }, this)
            );
        var h = this.get_widgets_under_player(
          this.cells_occupied_by_placeholder
        );
        h.length &&
          h.each(
            t.proxy(function (i, r) {
              ...
              this.move_widget_down(
                o,
                e + s.size_y - o.data("coords").grid.row
              );
            }, this)
          );
      }),
        ...
        return (
          this.for_each_column_occupied(t, function (t) {
            ...
            for (
              ...
              (this.is_empty(t, n) ||
                this.is_player(t, n) ||
                (this.is_widget(t, n) && a[n].is(o)));

            )
              s[t].push(n), (r = r > n ? n : r);
            return 0 === s[t].length
              ? ((e = !1), !0)
      ...
      (r.can_go_widget_up = function (t) {
        var i = t.row + t.size_y - 1,
          ...
          r = 1e4;
        return (
          this.for_each_column_occupied(t, function (o) {
            ...
            for (
              ...
              --n > 0 &&
              (!this.is_widget(o, n) ||
                this.is_player_in(o, n) ||
                a[n].is(t.el));

            )
              this.is_player(o, n) ||
                this.is_placeholder_in(o, n) ||
                this.is_player_in(o, n) ||
                s[o].push(n),
                r > n && (r = n);
            return 0 === s[o].length
      ...
      (r.get_valid_rows = function (i, e, s) {
        ...
        return (
          1 === a
            ? h[0] !== r && (d = h[0] || !1)
            : h[0] !== r && (d = this.get_consecutive_numbers_index(h, a)),
          d
        );
      }),
      ...
      (r.on_stop_overlapping_row = function (t) {
        ...
        for (
          var i = this,
            e = this.cells_occupied_by_player.cols,
            s = 0,
            r = e.length;
          r > s;
          s++
      ...
      (r.move_widget_to = function (i, e) {
        ...
        return a === !1
          ? !1
          : (this.remove_from_gridmap(r),
            (r.row = e),
            this.add_to_gridmap(r),
            i.attr("data-row", e),
            (this.$changed = this.$changed.add(i)),
            o.each(function (i, e) {
              var r = t(e),
                o = r.coords().grid,
      ...
      (r.move_widget_up = function (i, e) {
        ...
        return (
          e || (e = 1),
          this.can_go_up(i)
            ? (this.for_each_column_occupied(s, function (s) {
                if (-1 === t.inArray(i, o)) {
                  var a = i.coords().grid,
                    n = r - e;
                  if (((n = this.can_go_up_to_row(a, s, n)), !n)) return !0;
                  var h = this.widgets_below(i);
                  this.remove_from_gridmap(a),
                    (a.row = n),
                    this.add_to_gridmap(a),
                    i.attr("data-row", a.row),
                    (this.$changed = this.$changed.add(i)),
                    o.push(i),
                    h.each(
                      t.proxy(function (i, s) {
      ...
      (r.move_widget_down = function (i, e) {
        ...
        if (-1 === t.inArray(i, o)) {
          ...
          this.remove_from_gridmap(n),
            ...
            (n.row = h),
            this.update_widget_position(n, i),
            i.attr("data-row", n.row),
            (this.$changed = this.$changed.add(i)),
            o.push(i);
        }
      }),
      (r.can_go_up_to_row = function (i, e, s) {
        var r,
          ...
          h = i.row;
        if (
          (this.for_each_column_occupied(i, function (t) {
            for (
              o[t], n[t] = [], r = h;
              r-- && this.is_empty(t, r) && !this.is_placeholder_in(t, r);
          ...
          return !1;
        for (r = s, r = 1; h > r; r++) {
          for (var _ = !0, d = 0, l = n.length; l > d; d++)
            n[d] && -1 === t.inArray(r, n[d]) && (_ = !1);
          if (_ === !0) {
            a = r;
            break;
          }
      ...
      (r.widgets_below = function (i) {
        ...
        var o = s.row + s.size_y - 1,
          a = t([]);
        return (
          this.for_each_column_occupied(s, function (i) {
            r.for_each_widget_below(i, o, function () {
              return r.is_player(this) || -1 !== t.inArray(this, a)
                ? void 0
                : ((a = a.add(this)), !0);
            });
          }),
      ...
      (r.set_cells_player_occupies = function (t, i) {
        return (
          ...
          (this.placeholder_grid_data.row = i),
      ...
      (r.can_go_up = function (t) {
        ...
        return 1 === e
          ...
          : (this.for_each_column_occupied(i, function (t) {
              return (
                this.is_widget(t, s),
                this.is_occupied(t, s) ||
                this.is_player(t, s) ||
                this.is_placeholder_in(t, s) ||
                this.is_player_in(t, s)
                  ? ((r = !1), !0)
                  : void 0
              );
            }),
      ...
      (r.can_move_to = function (t, i, e, s) {
        this.gridmap;
        var r = t.el,
          o = { size_y: t.size_y, size_x: t.size_x, col: i, row: e },
          a = !0,
          n = i + t.size_x - 1;
        return n > this.cols
          ? !1
          : s && e + t.size_y - 1 > s
          ? !1
          : (this.for_each_cell_occupied(o, function (i, e) {
      ...
      (r.get_cells_occupied = function (i) {
        var e,
          s = { cols: [], rows: [] };
        for (
          arguments[1] instanceof t && (i = arguments[1].coords().grid), e = 0;
          i.size_x > e;
          e++
        ) {
          var r = i.col + e;
              ...
              "for_each/above": function () {
                for (
                  ...
                  !(
                    ...
                    this.is_widget(s, c) &&
                    -1 === t.inArray(a[s][c], l) &&
                    ((n = o.call(a[s][c], s, c)), l.push(a[s][c]), n)
                  );
      ...
      (r.set_dom_grid_width = function (t) {
        ...
        return (
          (t = Math.min(i, Math.max(t, this.options.min_cols))),
          (this.container_width = t * this.min_widget_width),
      ...
      (r.generate_stylesheet = function (i) {
        ...
        i || (i = {}),
          i.cols || (i.cols = this.cols),
          i.rows || (i.rows = this.rows),
          i.namespace || (i.namespace = this.options.namespace),
          i.widget_base_dimensions ||
            (i.widget_base_dimensions = this.options.widget_base_dimensions),
          i.widget_margins || (i.widget_margins = this.options.widget_margins),
          (i.min_widget_width =
            2 * i.widget_margins[0] + i.widget_base_dimensions[0]),
          (i.min_widget_height =
            2 * i.widget_margins[1] + i.widget_base_dimensions[1]);
        var a = t.param(i);
        if (t.inArray(a, e.generated_stylesheets) >= 0) return !1;
        for (
          this.generated_stylesheets.push(a),
            e.generated_stylesheets.push(a),
            s = i.cols;
          s >= 0;
          s--
        )
          r +=
            ...
            (s + 1) +
            '"] { left:' +
            (s * i.widget_base_dimensions[0] +
              s * i.widget_margins[0] +
              (s + 1) * i.widget_margins[0]) +
            "px; }\n";
        for (s = i.rows; s >= 0; s--)
          r +=
            i.namespace +
            ...
            (s + 1) +
            '"] { top:' +
            (s * i.widget_base_dimensions[1] +
              s * i.widget_margins[1] +
              (s + 1) * i.widget_margins[1]) +
            "px; }\n";
        for (var n = 1; i.rows >= n; n++)
          r +=
            i.namespace +
            ' [data-sizey="' +
            n +
            '"] { height:' +
            (n * i.widget_base_dimensions[1] +
              (n - 1) * 2 * i.widget_margins[1]) +
            "px; }\n";
        for (var h = 1; o >= h; h++)
          r +=
            i.namespace +
            ...
            h +
            '"] { width:' +
            (h * i.widget_base_dimensions[0] +
              (h - 1) * 2 * i.widget_margins[0]) +
            "px; }\n";
      ...
      (r.add_style_tag = function (t) {
        ...
        return (
          ...
          (this.$style_tags = this.$style_tags.add(e)),
          this
        );
      }),
      (r.remove_style_tags = function () {
        ...
        this.$style_tags.remove(),
          (e.generated_stylesheets = t.map(i, function (i) {
      ...
      (r.add_faux_cell = function (i, e) {
        ...
        return (
          t.isArray(this.gridmap[e]) || (this.gridmap[e] = []),
          (this.gridmap[e][i] = !1),
          this.faux_grid.push(s),
          this
        );
      }),
      ...
      (r.generate_grid_and_stylesheet = function () {
        ...
        (this.cols = Math.max(o, s, this.options.min_cols)),
          1 / 0 !== e && e >= o && this.cols > e && (this.cols = e);
        var a = this.options.extra_rows;
        return (
          this.$widgets.each(function (i, e) {
