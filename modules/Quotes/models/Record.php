...
class Quotes_Record_Model extends Inventory_Record_Model {
	...
	public function getCreateSalesOrderUrl() {
		...
		return "index.php?module=".$salesOrderModuleModel->getName()."&view=".$salesOrderModuleModel->getEditViewName()."&quote_id=".$this->getId()."&ship_to_party=".$this->get('account_id')."&ship_to_party=".$this->get('account_id');
	}
	...
	function getCreateServiceContaractUrl() {
		$purchaseOrderModuleModel = Vtiger_Module_Model::getInstance('SCAgree');
