...
class HelpDesk_GetAllInfoEquipment_Action extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		global $adb;
		$sql = "SELECT productname, model_number, warrenty_period, contact_period, service_offered 
		FROM `vtiger_equipment` WHERE equipmentid = ?";
		$sqlResult = $adb->pquery($sql, array($record));
		...
		$data['contract_period'] = $rowsValue['contact_period'];
		$data['service_offered'] = $rowsValue['service_offered'];
