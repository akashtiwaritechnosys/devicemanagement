...
class PeriodicalMaintainence_Record_Model extends Inventory_Record_Model {
    ...
    function getAssociatedProductsAnother2($module, $focus, $seid = '', $refModuleName = false) {
        ...
        // array_push($inventoryModules , 'SalesOrder');
        ...
        $query = "SELECT vtiger_pm_schedule.*
                    FROM vtiger_pm_schedule
                    WHERE id=?";
