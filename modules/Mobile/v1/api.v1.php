...
class Mobile_APIV1_Controller {
	...
	static $opControllers = array(
	    ...
	    'TicketsByStatusCounts'	=> array('file' => '/api/ws/HelpDesk/TicketsByStatusCounts.php',	'class' => 'Mobile_WS_TicketsByStatusCounts'),
	    'getRoleBaseAssignedPicklist' => array('file' => '/api/ws/crm/getRoleBaseAssignedPicklist.php',	'class' => 'Mobile_WS_getRoleBaseAssignedPicklist'),
		'DeleteAccount' => array('file' => '/api/ws/DeleteAccount.php', 'class' => 'Mobile_WS_DeleteAccount'),
		'CheckDuplicateTicket' => array('file' => '/api/ws/CheckDuplicateTicket.php', 'class' => 'Mobile_WS_CheckDuplicateTicket'),
		'PreLogin' => array('file' => '/api/ws/PreLogin.php', 'class' => 'Mobile_WS_PreLogin'),
		'DoOTPLogin' => array('file' => '/api/ws/DoOTPLogin.php', 'class' => 'Mobile_WS_DoOTPLogin'),
		'SSOLogin' => array('file' => '/api/ws/ssologin.php',	'class' => 'Mobile_WS_sslogin'),
	);
