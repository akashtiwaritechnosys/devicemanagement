...
$MODULENAME = 'PeriodicalMaintainence';
...
$result = $adb->pquery("SELECT id FROM vtiger_ws_entity WHERE name=? and handler_path=? and handler_class=?", array('PeriodicalMaintainence', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation'));
if ($adb->num_rows($result) == 0) {
        $sql = "INSERT INTO `vtiger_ws_entity` (`id`, `name`, `handler_path`, `handler_class`, `ismodule`) VALUES (NULL, 'PeriodicalMaintainence', 'include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation', '1')";
